        ...
        try
        {
            ...
            while (await reader.ReadAsync())
            {
                lista.Add(new AuthHorasEmpleadoDto
                {
                    ...
                    GranCCosto      = GetStr(reader, "gran_ccosto"),
                    GranCCostoNombre = GetStr(reader, "gran_ccosto_nombre"),
        ...
        try
        {
            ...
            while (await reader.ReadAsync())
            {
                lista.Add(new AuthHorasTareoDto
                {
                    ...
                    Alerta06        = GetStr(reader, "alerta06"),
                    ...
                    HayHedPorAut    = GetStr(reader, "hayhed_poraut"),
