    ...
    public async Task<List<PlanillaIngDsctoAportesDto>> ObtenerAsync(int anio, int semana, string ceo = "O", int? mes = null)
    {
        ...
        while (await reader.ReadAsync())
        {
            lista.Add(new PlanillaIngDsctoAportesDto
            {
                ...
                Comisiones    = Dec(reader, "COMISIONES"),
                Incentivo     = Dec(reader, "INCENTIVO"),
                ...
                AdelQuincena  = Dec(reader, "ADEL_QUINCENA"),
                OtrosDsctos   = Dec(reader, "OTROS_DSCTOS"),
                EntregaPrestac = Dec(reader, "ENTREGA_PRESTAC"),
                PacificoVida  = Dec(reader, "PACIFICO_VIDA"),
                RimacSeguros  = Dec(reader, "RIMAC_SEGUROS"),
                RimacEps      = Dec(reader, "RIMAC_EPS"),
                Snp           = Dec(reader, "SNP"),
