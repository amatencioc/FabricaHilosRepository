...
public interface IArchivoDocumentoService
{
    ...
    /// </summary>
    Task<string?> GuardarXmlAsync(DocumentoXml documento, string contenidoXml, CancellationToken ct = default);
    ...
    /// Devuelve la ruta completa donde se guardó el archivo, o <see langword="null"/> si no hay ruta configurada.
    /// </summary>
    Task<string?> GuardarPdfAsync(string nombreArchivoOriginal, byte[] contenido, DocumentoXml? documentoXml = null, CancellationToken ct = default);
}
